...
class DKPhotoImagePreviewVC: DKPhotoBaseImagePreviewVC {
    ...
    private func downloadImage(with identifier: Any,
        ...
        SDImageCache.shared().queryCacheOperation(forKey: key, options: SDImageCacheOptions.scaleDownLargeImages.union(.queryDataWhenInMemory)) { (image, data, cacheType) in
