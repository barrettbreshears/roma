...
class PadLocalTimelinesViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, SwipeTableViewCellDelegate, SKPhotoBrowserDelegate, URLSessionDataDelegate, UIViewControllerPreviewingDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.tableView.register(MainFeedCell.self, forCellReuseIdentifier: "celll")
        self.tableView.register(MainFeedCellImage.self, forCellReuseIdentifier: "cell2l")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
            ...
            if StoreStruct.statusesLocal.count == 0 {
                ...
                return cell
            } else if indexPath.row < StoreStruct.statusesLocal.count {
